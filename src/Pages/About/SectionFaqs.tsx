            ...
            <div className="section-faq-elm">
                ...
                <div className="section-faq-elm-question">
                    <div className="section-faq-elm-question-elment">       
                       ...
                       {faqQuestion === "question1" ? <p className="section-faq-elm-question-elment-text">Yes, please do! All cities have different laws. But we strongly strongly strongly recommend always wearing a helmet regardless of the local laws. We like you and we want you to be as safe as possible while Scooting.</p>: null} 
                    </div>
                </div>
                <div className="section-faq-elm-question">
                    <div className="section-faq-elm-question-elment">       
