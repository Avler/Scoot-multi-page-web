...
import arrowOpen from "../../assets/images/About/faq-arrow-open.png"
import arrowClose from "../../assets/images/About/faq-arrow-close.png"
                ...
                <div className="section-faq-box">
                    <div className="section-faq-elm-question">
                        <div className="section-faq-elm-question-elment">       
                            ...
                            {faqQuestion === "question1"? <img src={arrowOpen} onClick={() => openFaq("question1")} /> : <img src={arrowClose} onClick={() => openFaq("question1")}/>}  
                            </h2>
                    ...
                    <div className="section-faq-elm-question">
                        <div className="section-faq-elm-question-elment">       
                            ...
                            {faqQuestion === "question2"? <img src={arrowOpen} onClick={() => openFaq("question2")}/> : <img src={arrowClose} onClick={() => openFaq("question2")}/>}  
                            </h2>
                    ...
                    <div className="section-faq-elm-question">
                        <div className="section-faq-elm-question-elment">       
                            ...
                            {faqQuestion === "question3"? <img src={arrowOpen} onClick={() => openFaq("question3")}/> : <img src={arrowClose} onClick={() => openFaq("question3")}/>}  
                            </h2>
                ...
                <div className="section-faq-box">
                    <div className="section-faq-elm-question">
                        <div className="section-faq-elm-question-elment">       
                            ...
                            {faqQuestion === "question4"? <img src={arrowOpen} onClick={() => openFaq("question4")} /> : <img src={arrowClose} onClick={() => openFaq("question4")}/>}  
                            </h2>
                    ...
                    <div className="section-faq-elm-question">
                        <div className="section-faq-elm-question-elment">       
                            ...
                            {faqQuestion === "question5"? <img src={arrowOpen} onClick={() => openFaq("question5")}/> : <img src={arrowClose} onClick={() => openFaq("question5")}/>}  
                            </h2>
                    ...
                    <div className="section-faq-elm-question">
                        <div className="section-faq-elm-question-elment">       
                            ...
                            {faqQuestion === "question6"? <img src={arrowOpen} onClick={() => openFaq("question6")}/> : <img src={arrowClose} onClick={() => openFaq("question6")}/>}  
                            </h2>
