    ...
    return ( 
        <div className="cont-section2">
            <div className="cont-section2-elm">
                <img src="src\assets\images\Home\section-photo1.png"/>
                <img src="src\assets\images\Home\arrowpic.svg" className="section-home-arrow"/>
            ...
            <div className="cont-section2-elm">
                <img src="src\assets\images\Home\section-photo2.png"/>
                <img src="src\assets\images\Home\arrowpic.svg" className="section-home-arrow"/>
                <div className="cont-section2-elm-box">
            ...
            <div className="cont-section2-elm">
                <img src="src\assets\images\Home\section-photo3.png"/>
                <img src="src\assets\images\Home\arrowpic.svg" className="section-home-arrow"/>
                <div className="cont-section2-elm-box">
